    ...
    @else
        ...
        @section('content')
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <p class="mb-0">
                        {{ trans('fields.Case Number') }}: <span class="badge badge-secondary">{{ $case->number }}</span>
                        <br>
                        {{ trans('fields.Creator') }}: <span
                            class="badge badge-light">{{ getUserInfo($case->creator)->name }}</span>
                        <br>
