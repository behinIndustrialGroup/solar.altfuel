<div class="card mt-4">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('solar-plant-requests.battery.store', $solarPlantRequest) }}">
            @csrf
            <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <select name="manufacturer_user_id" class="form-select select2" required>
                        ...
                        @foreach($batteryManufacturers as $manufacturer)
            ...
            <div class="mt-3 text-end">
                <button type="submit" class="btn btn-primary">ثبت باتری</button>
            </div>
        </form>
    </div>
</div>
