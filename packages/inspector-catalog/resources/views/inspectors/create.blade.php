    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">افزودن بازرس جدید</h5>
                <a href="{{ route('inspector-catalog.index') }}" class="btn btn-secondary">
                    <i class="fa fa-arrow-right ms-1"></i> بازگشت
                </a>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('inspector-catalog.store') }}">
                    @csrf

                    {{-- انتخاب کاربر --}}
                    <fieldset class="mb-4">
                        <legend class="font-weight-bold text-primary" style="font-size:1rem; border-bottom: 2px solid #1976d2; padding-bottom:5px;">انتخاب کاربر</legend>
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <small class="text-muted">فقط کاربرانی که هنوز پروفایل بازرس ندارند نمایش داده می‌شوند.</small>
                            </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset class="mb-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                ...
                                <input type="text" name="inspector_code" class="form-control @error('inspector_code') is-invalid @enderror" value="{{ old('inspector_code') }}" required>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="national_id" class="form-control @error('national_id') is-invalid @enderror" value="{{ old('national_id') }}" required maxlength="10" placeholder="۱۰ رقم">
                    ...
                    <fieldset class="mb-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="mobile" class="form-control @error('mobile') is-invalid @enderror" value="{{ old('mobile') }}" required maxlength="11" placeholder="۰۹XXXXXXXXX">
                                @error('mobile') <div class="text-danger small">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">تلفن ثابت</label>
                                <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone') }}" maxlength="11" placeholder="مثال: ۰۲۱XXXXXXX">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex gap-4 mt-1">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="is_certificated" id="cert_yes" value="1" {{ old('is_certificated') == '1' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="cert_yes">بلی</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="is_certificated" id="cert_no" value="0" {{ old('is_certificated', '0') == '0' ? 'checked' : '' }}>
