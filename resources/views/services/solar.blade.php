    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div class="grid md:grid-cols-3 gap-6">
        <div class="glass rounded-2xl p-6 shadow-lg">
          ...
          <p class="text-gray-700 leading-7">با بهره‌گیری از پنل‌های نسل جدید، هزینه برق شما به شکل محسوسی کاهش می‌یابد و سرمایه‌گذاری‌تان در مدت کوتاهی بازمی‌گردد.</p>
        </div>
        <div class="glass rounded-2xl p-6 shadow-lg">
          <h3 class="text-xl font-black text-gray-900 mb-2">قدرتی پاک و پایدار</h3>
          <p class="text-gray-700 leading-7">به آینده‌ای سبز سلام کنید؛ انرژی خورشیدی بدون آلودگی و با کمترین نیاز به نگهداری در اختیار شماست.</p>
        </div>
        <div class="glass rounded-2xl p-6 shadow-lg">
          <h3 class="text-xl font-black text-gray-900 mb-2">همراهی از مشاوره تا روشنایی</h3>
          <p class="text-gray-700 leading-7">از ایده تا اجرا کنار شما هستیم؛ بررسی محل، طراحی، نصب و پشتیبانی، همه با یک تیم حرفه‌ای.</p>
        </div>
      </div>
